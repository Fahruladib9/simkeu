...
class C_LaporanSpp extends BaseController
{
    ...
    {
        return view('admin_keuangan/laporan/spp/laporan_spp');
    }
    ...
    public function cetak()
    {
        ...
        $data['spp'] = $this->spp->where('tanggal <=', $tanggalAkhir)->where('tanggal >=', $tanggalAwal)->findAll();
        ...
        // return view('admin_keuangan/laporan/spp/_cetakSpp', $data);
        $dompdf->loadHtml(view('admin_keuangan/laporan/spp/_cetakSpp', $data));
        $filename = date('y-m-d-H-i-s') . ' - laporan SPP';
