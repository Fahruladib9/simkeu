                                    ...
                                    <?php foreach ($donatur as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td class="col-2 text-center">
                                                <a href="<?= base_url(); ?>donatur/edit/<?= $value->id_donatur; ?>" class="btn btn-warning btn-sm mr-1"><i class="fas fa-pencil-alt"></i></a>
                                                <form action="<?= base_url(); ?>donatur/delete/<?= $value->id_donatur; ?>" method="POST" class="d-inline" onsubmit="return confirm('Yakin mau hapus data?')">
