    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url(); ?>admin/masuk/koperasi/tambah" method="POST">
                                    ...
                                    <?php foreach ($koperasi as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td class="col-2 text-center">
                                                <a href="<?= base_url(); ?>admin/masuk/koperasi/edit/<?= $value->id_trKoperasi; ?>" class="btn btn-warning btn-sm mr-1"><i class="fas fa-pencil-alt"></i></a>
                                                <form action="<?= base_url(); ?>admin/masuk/koperasi/delete/<?= $value->id_trKoperasi; ?>" method="POST" class="d-inline" onsubmit="return confirm('Yakin mau hapus data?')">
