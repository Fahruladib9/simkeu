    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url(); ?>admin/keluar/tambah" method="POST">
                                    ...
                                    <?php foreach ($keluar as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td class="col-2 text-center">
                                                <a href="<?= base_url(); ?>admin/keluar/edit/<?= $value->id_tKeluar; ?>" class="btn btn-warning btn-sm mr-1"><i class="fas fa-pencil-alt"></i></a>
                                                <form action="<?= base_url(); ?>admin/keluar/delete/<?= $value->id_tKeluar; ?>" method="POST" class="d-inline" onsubmit="return confirm('Yakin mau hapus data?')">
