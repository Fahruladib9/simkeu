    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit Data</h1>
                    <a href="<?= base_url(); ?>santri" class="btn btn-outline-secondary mt-4 px-3 ml-3">
                        Kembali
                    </a>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container-fluid ">
            <div class="row">
                <div class="col-11 mx-auto">
                    <div class="card">
                        <!-- /.card-header -->
                        <form action="<?= base_url(); ?>santri/update/<?= $santri->id_santri; ?>" method="POST" class="m-4">
                            <div class="form-group">
                                <label for="nis">Nis</label>
                                <input type="number" class="form-control" id="nis" name="nis" value="<?= $santri->nis; ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="no_hp" name="no_hp" value="<?= $santri->no_hp; ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="nama_wali">Nama Wali</label>
                                <input type="text" class="form-control" id="nama_wali" name="nama_wali" value="<?= $santri->nama_wali; ?>" required>
                            </div>
                            <div class="form-group">
