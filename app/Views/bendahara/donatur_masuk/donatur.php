    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url(); ?>admin/masuk/donatur/tambah" method="POST" enctype="multipart/form-data">
                                    ...
                                    <?php foreach ($donatur as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td class="col-2 text-center">
                                                <a href="<?= base_url(); ?>admin/masuk/donatur/edit/<?= $value->id_trDonatur; ?>" class="btn btn-warning btn-sm mr-1"><i class="fas fa-pencil-alt"></i></a>
                                                <form action="<?= base_url(); ?>admin/masuk/donatur/delete/<?= $value->id_trDonatur; ?>" method="POST" class="d-inline" onsubmit="return confirm('Yakin mau hapus data?')">
