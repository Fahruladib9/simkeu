    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit Data</h1>
                    <a href="<?= base_url(); ?>masuk/donatur" class="btn btn-outline-secondary mt-4 px-3 ml-3">
                        Kembali
                    </a>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container-fluid ">
            <div class="row">
                <div class="col-11 mx-auto">
                    <div class="card">
                        <!-- /.card-header -->
                        <form action="<?= base_url(); ?>masuk/donatur/update/<?= $donatur->id_trDonatur; ?>" enctype="multipart/form-data" method="POST" class="m-4">
