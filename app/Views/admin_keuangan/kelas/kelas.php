                                    ...
                                    <?php foreach ($kelas as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td class="col-2 text-center">
                                                <a href="<?= base_url(); ?>kelas/edit/<?= $value->id_kelas; ?>" class="btn btn-warning btn-sm mr-1"><i class="fas fa-pencil-alt"></i></a>
                                                <form action="<?= base_url(); ?>kelas/delete/<?= $value->id_kelas; ?>" method="POST" class="d-inline" onsubmit="return confirm('Yakin mau hapus data?')">
