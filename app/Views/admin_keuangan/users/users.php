                ...
                <form action="<?= base_url(); ?>users/tambah" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control searchselect" name="role" id="role" required>
                                    ...
                                    <?php foreach ($users as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td class="col-2 text-center">
                                                <a href="<?= base_url(); ?>users/edit/<?= $value->id_user; ?>" class="btn btn-warning btn-sm mr-1"><i class="fas fa-pencil-alt"></i></a>
                                                <form action="<?= base_url(); ?>users/delete/<?= $value->id_user; ?>" method="POST" class="d-inline" onsubmit="return confirm('Yakin mau hapus data?')">
