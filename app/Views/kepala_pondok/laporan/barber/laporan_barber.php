<?= $this->extend('layout/kepala_pondok'); ?>

<?= $this->section('title'); ?>
<title>Laporan - Barber</title>
<?= $this->endSection(); ?>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Laporan Barber</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url(); ?>kepala">Home</a></li>
                        <li class="breadcrumb-item active">laporan-barber</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="section-header-button mb-3">
                <a href="/kepala" class="btn btn-outline-secondary">Kembali</a>
            </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="<?= base_url(); ?>laporan/barber/cetak" method="post" autocomplete="off">
